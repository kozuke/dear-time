  ...
  return (
    <div className="flex flex-col items-start relative min-h-screen bg-gradient-to-br from-[#FFF5EA] to-[#FFE4E1]">
      <div className="flex flex-col min-h-[800px] items-start relative self-stretch w-full">
        ...
        <main className="items-start justify-center px-4 md:px-8 lg:px-40 py-5 flex-1 grow flex relative self-stretch w-full">
          <div className="flex flex-col max-w-[960px] h-[695px] items-start relative flex-1 grow mx-auto">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="flex flex-col items-center pt-5 pb-3 px-4 self-stretch w-full relative flex-[0_0_auto]"
            >
              <h2 className="self-stretch mt-[-1.00px] font-dancing text-[#896b60] text-4xl text-center tracking-[0] leading-relaxed">
            ...
            >
              <p className="self-stretch mt-[-1.00px] font-normal text-[#896b60] text-lg text-center tracking-[0] leading-6">
            ...
            >
              <h3 className="self-stretch mt-[-1.00px] font-dancing text-[#896b60] text-5xl text-center tracking-[0] leading-relaxed">
                ...
                <CardContent className="flex flex-col items-start gap-3 p-4 self-stretch w-full relative flex-[0_0_auto]">
                  <div className="justify-between self-stretch w-full flex-[0_0_auto] flex items-start relative">
                    <div className="inline-flex flex-col items-start relative flex-[0_0_auto]">
                      <h4 className="whitespace-nowrap relative self-stretch mt-[-1.00px] font-medium text-[#896b60] text-lg tracking-[0] leading-6">
                        経過時間
                      </h4>
                    </div>
                    ...
                    <div className="inline-flex flex-col h-6 items-start relative flex-[0_0_auto]">
                      <motion.span
                        ...
                        className="relative self-stretch mt-[-1.00px] font-normal text-[#896b60] text-lg tracking-[0] leading-[21px] whitespace-nowrap"
                      >
                        {progressPercentage}%
                      </motion.span>
                    </div>
            ...
            >
              <Card className="border-none shadow-none w-full bg-white/60 backdrop-blur-sm mt-6">
                <CardContent className="flex flex-wrap items-start gap-[16px_16px] px-4 py-6 self-stretch w-full relative flex-[0_0_auto]">
                  <div className="flex-col min-w-72 gap-2 flex-1 grow flex items-start relative">
                    <div className="flex flex-col items-start relative self-stretch w-full flex-[0_0_auto]">
                      <h4 className="relative self-stretch mt-[-1.00px] font-medium text-[#896b60] text-lg tracking-[0] leading-6">
                        接触時間の推移
                      </h4>
                    </div>
                    ...
                    <motion.div
                      ...
                      className="relative w-full h-[350px] bg-white/80 rounded-lg p-4 shadow-sm"
                    >
                    ...
                    >
                      <div className="flex items-start gap-1 relative self-stretch w-full flex-[0_0_auto]">
                        <span className="relative self-stretch mt-[-1.00px] font-normal text-[#896b60] text-lg tracking-[0] leading-6 whitespace-nowrap">
                          現在の年齢: {currentAge}歳
                        </span>
                        <span className="relative self-stretch mt-[-1.00px] font-medium text-[#07870a] text-lg tracking-[0] leading-6 whitespace-nowrap">
                      ...
                      {[
                        ...
                        <div key={`milestone-text-${percentage}`} className="text-base text-[#896b60]">
            ...
            <motion.div
              ...
              className="flex flex-col items-center pt-6 pb-3 px-4 relative self-stretch w-full flex-[0_0_auto]"
            >
              <p className="relative self-stretch mt-[-1.00px] font-dancing text-[#896b60] text-2xl text-center tracking-[0] leading-relaxed">
                {randomMessage}
              </p>
            </motion.div>
          </div>
